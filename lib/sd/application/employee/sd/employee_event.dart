...
// //-------------------Bh-Delete-Scheduled-Transcations----------------
  ...
  const factory EmployeeEvent.makerCheckerReject({
  ...
  const factory EmployeeEvent.makerCheckerGetDetails() =
      _MakerCheckerGetDetails;

  const factory EmployeeEvent.makerApprovalApiCalling(
      {required int firmid,
      required int branchid,
      required int moduleId,
      required String depositId,
      ...
      required int amount,
      required int referenceId,
      required String checkerName}) = _MakerApprovalApiCalling;
