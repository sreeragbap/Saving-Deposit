...
/// @nodoc
class _$RdCustomerAccountFailuresTearOff {
  const _$RdCustomerAccountFailuresTearOff();

  _SessionTimeouts sessionTimeouts(String timeout) {
...
/// @nodoc
const $RdCustomerAccountFailures = _$RdCustomerAccountFailuresTearOff();
...
abstract class $RdCustomerAccountFailuresCopyWith<$Res> {
  factory $RdCustomerAccountFailuresCopyWith(RdCustomerAccountFailures value,
      ...
      _$RdCustomerAccountFailuresCopyWithImpl<$Res>;
}
...
class _$RdCustomerAccountFailuresCopyWithImpl<$Res>
  ...
  final RdCustomerAccountFailures _value;
  // ignore: unused_field
  final $Res Function(RdCustomerAccountFailures) _then;
}

/// @nodoc
abstract class _$SessionTimeoutsCopyWith<$Res> {
  factory _$SessionTimeoutsCopyWith(
          _SessionTimeouts value, $Res Function(_SessionTimeouts) then) =
      __$SessionTimeoutsCopyWithImpl<$Res>;
  $Res call({String timeout});
}

/// @nodoc
class __$SessionTimeoutsCopyWithImpl<$Res>
    extends _$RdCustomerAccountFailuresCopyWithImpl<$Res>
    implements _$SessionTimeoutsCopyWith<$Res> {
  __$SessionTimeoutsCopyWithImpl(
      _SessionTimeouts _value, $Res Function(_SessionTimeouts) _then)
      : super(_value, (v) => _then(v as _SessionTimeouts));

  @override
  _SessionTimeouts get _value => super._value as _SessionTimeouts;

  @override
  $Res call({
    Object? timeout = freezed,
  }) {
    return _then(_SessionTimeouts(
      timeout == freezed
          ? _value.timeout
...
class _$_SessionTimeouts implements _SessionTimeouts {
  ...
  @JsonKey(ignore: true)
  @override
  _$SessionTimeoutsCopyWith<_SessionTimeouts> get copyWith =>
      __$SessionTimeoutsCopyWithImpl<_SessionTimeouts>(this, _$identity);
...
abstract class _SessionTimeouts implements RdCustomerAccountFailures {
  const factory _SessionTimeouts(String timeout) = _$_SessionTimeouts;
