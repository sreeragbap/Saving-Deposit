...
/// @nodoc
class _$RdChequeReconciliationFailureTearOff {
  const _$RdChequeReconciliationFailureTearOff();

  _RdChequeReconciliationFailure sessionTimeout(String timeout) {
    return _RdChequeReconciliationFailure(
      timeout,
    );
  }
...
/// @nodoc
const $RdChequeReconciliationFailure = _$RdChequeReconciliationFailureTearOff();
...
class _$RdChequeReconciliationFailureCopyWithImpl<$Res>
  ...
  final RdChequeReconciliationFailure _value;
  // ignore: unused_field
  final $Res Function(RdChequeReconciliationFailure) _then;
}

/// @nodoc
abstract class _$RdChequeReconciliationFailureCopyWith<$Res> {
  factory _$RdChequeReconciliationFailureCopyWith(
          _RdChequeReconciliationFailure value,
          $Res Function(_RdChequeReconciliationFailure) then) =
      __$RdChequeReconciliationFailureCopyWithImpl<$Res>;
  $Res call({String timeout});
}

/// @nodoc
class __$RdChequeReconciliationFailureCopyWithImpl<$Res>
    extends _$RdChequeReconciliationFailureCopyWithImpl<$Res>
    implements _$RdChequeReconciliationFailureCopyWith<$Res> {
  __$RdChequeReconciliationFailureCopyWithImpl(
      _RdChequeReconciliationFailure _value,
      $Res Function(_RdChequeReconciliationFailure) _then)
      : super(_value, (v) => _then(v as _RdChequeReconciliationFailure));

  @override
  _RdChequeReconciliationFailure get _value =>
      super._value as _RdChequeReconciliationFailure;

  @override
  $Res call({
    Object? timeout = freezed,
  }) {
    return _then(_RdChequeReconciliationFailure(
      timeout == freezed
          ? _value.timeout
...
class _$_RdChequeReconciliationFailure
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RdChequeReconciliationFailure &&
  ...
  @JsonKey(ignore: true)
  @override
  _$RdChequeReconciliationFailureCopyWith<_RdChequeReconciliationFailure>
      get copyWith => __$RdChequeReconciliationFailureCopyWithImpl<
          _RdChequeReconciliationFailure>(this, _$identity);
...
abstract class _RdChequeReconciliationFailure
  ...
  const factory _RdChequeReconciliationFailure(String timeout) =
